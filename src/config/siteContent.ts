      ...
      items: [
        {
          ...
          price: "£25",
          description:
            "A treatment that smooths and sets brows to create a fuller, lifted and more defined brow shape, whilst tint adds colour and definition. Includes brow mapping and waxing for a clean finish.",
        },
        {
          name: "Brow and Tint",
          price: "£15",
          description:
            "Shaping and defining the brows with wax whilst tint enhances colour and fullness. Includes brow mapping.",
        },
        {
          name: "Brow Lamination and Wax",
          price: "£20",
          description:
            "Sets brows into a lifted, fuller and more defined brow shape without adding colour. Is ideal for a more natural look. Includes brow mapping and waxing.",
        },
        {
          name: "Brow Touch Up",
          price: "£15",
          description:
            "A maintenance appointment for existing clients to tidy regrowth, refine shape and refresh brows between full treatments.",
        },
        {
          name: "Brow Wax Only",
          price: "£10",
        ...
        },
        {
          ...
          price: "£25",
          description:
            "Uses Halal-friendly brow stain for defined, filled-in brows. Includes bleaching around the brow area for a polished look. This service does not remove hairs. Brow lamination and mapping included.",
        },
      ],
    },
    {
      ...
      note:
        "Note: Lashes are included with every appointment. However, clients are welcome to provide their own if preferred.",
      items: [
        {
          name: "Natural Glam",
          price: "£15",
          description:
            "A minimal and simplistic makeup look aimed to enhance your gorgeous natural features. Smooth, glowing skin like base with soft contour and natural lashes. No eyeshadow for an effortless natural finish.",
        },
        {
          name: "Softglam",
          price: "£20",
          description:
            "Soft Glam is all about enhancing your natural beauty with a luxe touch, flawless skin, soft contouring, a subtle glow and minimal yet refined eyeshadow.",
        },
        {
          name: "Full Glam",
          price: "£25",
          description:
            "A full coverage look with bolder eyeshadow, defined contour and a polished finish. Perfect for any occasion where you want a more dramatic glam.",
        },
      ],
    },
  ],
  ...
  policies: {
    ...
    items: [
      ...
      },
      {
        title: "Running Late?",
        content:
          "We offer a 15-minute grace period if you're running late. After this time, your appointment will automatically be cancelled. Please always contact us as soon as possible if you're delayed. Communication makes all the difference!",
      },
      {
        title: "Rescheduling",
        content:
          "Need to reschedule? No problem, as long as you do so at least 48 hours before your appointment.",
      },
      {
        title: "No Shows",
        content:
          "If you do not attend your appointment without notice, you will be banned from booking future appointments with us. We deeply value your time and ask for the same in return.",
      },
      {
        title: "During Your Appointment",
        content:
          "We understand the pull of your phone, but please minimise phone usage during your appointment. Constant head tilting or looking down can disrupt the process and affect your final look. Your cooperation helps us give you the best possible glam.",
      },
      {
        title: "Mobile Bookings",
        content:
          "We offer mobile services for your convenience. However, these appointments incur an additional fee to cover transport. Please contact us for further information.",
      },
      {
    ...
    outroText:
      "We truly appreciate your understanding and cooperation. These policies are in place to give every client the attention, time and service they deserve. We can't wait to create a look you'll love, thank you for choosing us!",
