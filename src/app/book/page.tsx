...
export default function BookPage() {
  const renderWithLinks = (text: string) => {
    const parts = text.split(/(contact us|policies)/gi);
    ...
    <div className="w-full">
      <section className="relative isolate w-full overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-16 md:py-24">
          <div className="text-center max-w-2xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-white">Book an Appointment</h1>
            ...
            <p className="font-medium text-white">
              ...
              <Link
                href="/policies"
                className="underline decoration-white/40 underline-offset-4 hover:decoration-white transition-all"
              >
                policies
              </Link>
              .
      ...
      <div className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-50 rounded-[var(--radius-card)] p-6 md:p-10">
